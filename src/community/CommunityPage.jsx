              ...
              {challenges.map(ch => (
                <div key={ch.id} style={styles.challengeItem} className="glass-panel">
                  <div style={styles.challengeInfo}>
                    ...
                    <p style={styles.challengeParticipants}>{ch.participants.toLocaleString()} joined</p>
                  </div>
                  <button 
...
// Inject community view responsive tweaks style block
const communityLayoutSheet = document.createElement("style");
communityLayoutSheet.innerText = `
  @media (max-width: 900px) {
    div[style*="communityPageGrid"] {
      grid-template-columns: 1fr !important;
    }
  }
`;
document.head.appendChild(communityLayoutSheet);
